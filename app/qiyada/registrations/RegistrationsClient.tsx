      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="relative">
          ...
          <input
            ...
            className={`py-2 border border-gray-200 rounded-xl focus:ring-2 focus:ring-school-gold outline-none w-full md:w-64 ${isAr
        ...
        {[
          ...
          return (
            <button
              ...
              className={`flex items-center gap-2 px-4 md:px-6 py-2.5 rounded-lg text-sm font-bold transition-all duration-200 ${isActive
